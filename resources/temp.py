...
def generate_eval_message(transcript, context = SERMON_REVIEW_CONTEXT, outline = None):
    ...
    message = f"""You are writing a sermon evaluation based on Bryan Chappell's book, Christ-Centered Preaching. You are evaluating the sermon based on the following criteria:
